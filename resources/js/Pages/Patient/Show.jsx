      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <fieldset
              disabled
              className="p-2 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg font-bold"
            >
              <div className="text-right">
                <Link
                  href={route("patient.index")}
                  className="bg-200 py-1 px-3 text-gray-800 rounded shadow transition-all hover:bg-gray-300 mr-2"
                >
                  Back
                </Link>
              </div>
